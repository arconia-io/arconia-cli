...
/**
 * Represents a summary of a project catalog.
 */
public record ProjectCatalogSummary(
        String name,
        String description,
        String type,
        List<String> labels,
    ...
    public static class Builder {
        ...
        public ProjectCatalogSummary build() {
            return new ProjectCatalogSummary(name, description, type, labels, version, ref);
        }
