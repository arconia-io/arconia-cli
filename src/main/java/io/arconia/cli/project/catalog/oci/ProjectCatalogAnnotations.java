...
/**
 * Manage annotations for Project Catalogs OCI artifacts.
 */
public final class ProjectCatalogAnnotations {

    private ProjectCatalogAnnotations() {}

    public static Map<String, String> computeAnnotations(Path projectDirectory, ProjectCatalogPushArguments arguments) {
