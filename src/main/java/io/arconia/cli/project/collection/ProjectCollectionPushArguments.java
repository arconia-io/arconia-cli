...
/**
 * Gathers all the information needed to push a project collection as an OCI artifact.
 */
public record ProjectCollectionPushArguments(
    String ref,
    String tag,
    String name,
    String description,
    ...
    public ProjectCollectionPushArguments {
    ...
    public static class Builder {
        ...
        public ProjectCollectionPushArguments build() {
            return new ProjectCollectionPushArguments(ref, tag, name, description, annotations, projects, fromReport, reportFileName);
        }
