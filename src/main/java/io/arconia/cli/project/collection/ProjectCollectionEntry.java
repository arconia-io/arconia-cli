...
/**
 * Represents a single entry in a project collection.
 */
public record ProjectCollectionEntry(
        String name,
        String ref,
        String tag,
        String digest,
    ...
    public static class Builder {
        ...
        public ProjectCollectionEntry build() {
            return new ProjectCollectionEntry(name, ref, tag, digest, description, type, labels);
        }
