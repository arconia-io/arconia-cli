...
public class MigrationCommands {
    ...
    public void rewrite(
        ...
        @Option(required = true, description = "Name of the OpenRewrite recipe to run. Example: 'io.arconia.rewrite.spring.ai.UpgradeSpringAi_1_0'.") String recipeName,
        @Option(description = "Maven coordinates of the library containing the OpenRewrite recipe to run. If not provided, the OpenRewrite OSS core recipe library will be used. Example: 'io.arconia.migrations:rewrite-arconia'.") String recipeLibrary,
        @Option(description = "Version of the library containing the OpenRewrite recipe to run. If not provided, the latest available version will be used. Example: '4.2.0'.") String recipeVersion,
