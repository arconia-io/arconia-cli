...
* **Discuss First.** For non-trivial changes, [open an issue](https://github.com/arconia-io/arconia-cli/issues/new/choose) before starting work. PRs without a prior discussion may be rejected.
* **Use Discussions for Questions.** The issue tracker is not for support questions. Use [GitHub Discussions](https://github.com/arconia-io/arconia-cli/discussions) instead.
...
For a detailed guide on building, installing, and running the CLI from source, see the [Development](https://docs.arconia.io/arconia-cli/latest/contributing/development.html) documentation.

## Contribution Workflow

1. **Find or create an issue.** Ensure a [GitHub Issue](https://github.com/arconia-io/arconia-cli/issues) exists for the change you want to make.
...
Use [GitHub Issues](https://github.com/arconia-io/arconia-cli/issues/new/choose) with the appropriate template. Before submitting, search existing issues to avoid duplicates and ensure bugs are reproducible with the latest version.
