...
Update
    update, upgrade framework: Update project to new Arconia Framework version.
    update, upgrade gradle: Update project to new Gradle version.
    update, upgrade maven: Update project to new Maven version.
    update, upgrade spring-ai: Update project to new Spring AI version.
    update, upgrade spring-boot: Update project to new Spring Boot version.
----
